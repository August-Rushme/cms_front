<!--
 * @Author: August
 * @Date: 2021-09-27 08:12:28
 * @LastEditors: August
 * @LastEditTime: 2021-09-30 11:31:16
 * @FilePath: \rookie-cms\src\views\not-found\not-found.vue
-->
<template>
  <!-- about -->
  <div class="error">
    ...
    <section class="wrapper">
      <div class="container">
        ...
        <div class="text">
          <article>
            <p>从前有座山，山里有座庙 <br />庙里有个网页，现在找不到!</p>
            <button @click="goBack">回庙!</button>
          </article>
        </div>
      </div>
    </section>
